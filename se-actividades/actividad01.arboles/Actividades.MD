...
* `Naive.Bayes.pdf`
* `arboles/arbol-decision-ID3%20algoritmo.pdf`
...
1. pdf con una presentación del rpoceso y el resultado de la aplicación de ID3 a iris
2. prsentación en pdf del punto aplicar el agoritmo J48 a iris en weka
